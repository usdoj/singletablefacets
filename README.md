...
# Dates also prevent an interesting problem with facets. Columns that you list
# here, if displayed as a facet, will be a hierarchy date facet, where you first
# select the year, month, day, etc. For each, indicate the lowest granularity
# that the facet should reach. Choices are: "year", "month", "day". This choice
# also affects the display of the date in the search results.
#columns that are dates:
#    myDatabaseColumn1: month
#    myDatabaseColumn2: day
